...
iteracionA f q xs ys zs s (P ((e,d), n, i)) 
...
probabilidadA q (((P ((x,y),m,i)),(s,t)):xs)
...
abejas = do putStr "Elija la función que quiere optimizar indicando el número correspondiente: \n"
            ...
            let texto = "semilla = " ++ show (seed) ++ ", rango del ejex = " ++ show (ejex) ++ ", rango del eje y = " ++ show (ejey) ++ ", obreras = " ++ show (obre) ++ ", ciclos = " ++show (numCiclos) ++ ", parada = " ++ show (parada)++ " "++ show ( algoritmoA func seed ejex ejey (enjambre func seed ejex ejey obre) numCiclos parada)
...
menu = do putStr "Elija el algoritmo que quiere realizar indicando el número correspondiente: \n"
                ...
                case entero of
                    ...
                    3 -> do hormigas
                            menu
                    otherwise -> putStr "Este algoritmo no está implementado."
